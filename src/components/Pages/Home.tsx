  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('https://github.com/vinuthm3190/iccwsc-cricket-club/blob/main/dist/assets/images/hero_image.png?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`,
